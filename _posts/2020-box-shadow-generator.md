...
This tool lets you construct CSS [`box-shadow`](../box-shadow) effects,
to add box shadow effects to your CSS objects.

box-shadow generator {#box-shadow_generator name="box-shadow_generator"}
--------------------
...
**Related Tool:**[Box Shadow CSS
Generator](https://cssgenerator.org/box-shadow-css-generator.html)

[Edit this page on
MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Box_Model/Box-shadow_generator$edit)

© 2005–2018 Mozilla Developer Network and individual contributors.\
Licensed under the Creative Commons Attribution-ShareAlike License v2.5
or later.\

[https://developer.mozilla.org/en-US/docs/Web/CSS/CSS\_Box\_Model/Box-shadow\_generator](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Box_Model/Box-shadow_generator)
